/* PrismJS 1.24.1
https://prismjs.com/download.html#themes=prism-tomorrow&languages=markup+css+clike+javascript+bash+docker+elixir+elm+git+go+haskell+javadoclike+json+json5+lua+markdown+markup-templating+mongodb+nginx+perl+php+phpdoc+php-extras+purescript+python+jsx+tsx+rust+scss+sql+toml+typescript+typoscript+wasm&plugins=line-highlight */
